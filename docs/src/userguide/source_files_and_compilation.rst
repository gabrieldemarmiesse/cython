...
platform for generating an extension module.

How to compile your ``.c`` files will vary
...
in your system's command shell and you are done.  Import your new extension
